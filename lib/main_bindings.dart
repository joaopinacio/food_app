...
import 'package:food_app/core/repositories/camera_repository/camera_repository_impl.dart';
...
class MainBindings implements CoreBindings {
  ...
  void registerRepositories() {
    ...
    Get.put(FirebaseStorage.instance, permanent: true);
