...
class RestaurantRepositoryImpl implements IRestaurantRepository {
  ...
  Future<bool> saveRestaurant({
    ...
    try {
      ...
      if (logoImageModel.hashMd5 != null && logoImageModel.hashMd5?.isNotEmpty == true) {
        loadLogoImage = await cameraRepository.sendImageToStorage(
